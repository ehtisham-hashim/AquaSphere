        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="space-y-2 pt-2 border-t border-slate-100">
            <div className="flex items-center gap-1.5 text-xs font-semibold text-slate-500 uppercase">
              <ShoppingBag size={14} className={isWadaana ? 'text-[#0ea5e9]' : 'text-emerald-600'} />
            ...
            {!isWadaana ? (
              <div className="grid grid-cols-3 gap-2 bg-slate-50 p-3 rounded-lg border border-slate-200 text-xs">
                <label className="flex items-center gap-1.5 cursor-pointer font-medium text-slate-700">
                  <input type="checkbox" name="buys19L" checked={form.buys19L} onChange={handleChange} className="rounded text-emerald-600 focus:ring-emerald-500" />
                  <span>19L Bottle</span>
                </label>
                <label className="flex items-center gap-1.5 cursor-pointer font-medium text-slate-700">
                  <input type="checkbox" name="buys05LPet" checked={form.buys05LPet} onChange={handleChange} className="rounded text-emerald-600 focus:ring-emerald-500" />
                  <span>0.5L PET</span>
                </label>
                <label className="flex items-center gap-1.5 cursor-pointer font-medium text-slate-700">
                  <input type="checkbox" name="buys15LPet" checked={form.buys15LPet} onChange={handleChange} className="rounded text-emerald-600 focus:ring-emerald-500" />
                  <span>1.5L PET</span>
                </label>
              </div>
            ) : (
              <div className="space-y-2.5 bg-slate-50 p-3 rounded-lg border border-slate-200 text-xs">
                <div>
                  <div className="font-bold text-[#0ea5e9] uppercase tracking-wider mb-1.5">Pure Preform Bottles</div>
                  <div className="grid grid-cols-2 gap-2 pl-2.5 border-l border-[#0ea5e9]/40">
                    <label className="flex items-center gap-1.5 cursor-pointer font-medium text-slate-700">
                      <input type="checkbox" name="buysPure05L" checked={form.buysPure05L} onChange={handleChange} className="rounded text-[#0ea5e9] focus:ring-[#0ea5e9]" />
                      <span>0.5L Pure <span className="text-slate-400 font-normal">(15g)</span></span>
                    </label>
                    <label className="flex items-center gap-1.5 cursor-pointer font-medium text-slate-700">
                      <input type="checkbox" name="buysPure15L" checked={form.buysPure15L} onChange={handleChange} className="rounded text-[#0ea5e9] focus:ring-[#0ea5e9]" />
                      <span>1.5L Pure <span className="text-slate-400 font-normal">(30g)</span></span>
                    </label>
                  </div>
                </div>
                <div className="pt-1.5 border-t border-slate-200">
                  <div className="font-bold text-amber-600 uppercase tracking-wider mb-1.5">Mix Preform Bottles</div>
                  <div className="grid grid-cols-2 gap-2 pl-2.5 border-l border-amber-500/40">
                    <label className="flex items-center gap-1.5 cursor-pointer font-medium text-slate-700">
                      <input type="checkbox" name="buysMix05L" checked={form.buysMix05L} onChange={handleChange} className="rounded text-amber-600 focus:ring-amber-500" />
                      <span>0.5L Mix <span className="text-slate-400 font-normal">(13g)</span></span>
                    </label>
                    <label className="flex items-center gap-1.5 cursor-pointer font-medium text-slate-700">
                      <input type="checkbox" name="buysMix15L" checked={form.buysMix15L} onChange={handleChange} className="rounded text-amber-600 focus:ring-amber-500" />
                      <span>1.5L Mix <span className="text-slate-400 font-normal">(27g)</span></span>
                    </label>
                  </div>
                </div>
              </div>
