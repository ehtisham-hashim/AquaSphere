...
export default function DailyClose() {
  ...
  useEffect(() => {
    fetchStatus();
    // Reset checklists when date changes
      ...
      <div className="bg-slate-900 text-white p-6 rounded-2xl shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4 border border-slate-800">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-400">Two-Step Verification Protocol</span>
          </div>
          <h1 className="text-2xl font-bold mt-1 flex items-center gap-2">
            <ShieldCheck className="w-6 h-6 text-emerald-400" /> Daily Close Checklist
          </h1>
        ...
        <div>
          <input 
            ...
            className="px-4 py-2 bg-slate-800 border border-slate-700 rounded-xl text-sm font-semibold outline-none focus:border-emerald-500 transition-colors"
          />
        </div>
      </div>
            ...
            {isPM && !pmConfirmed && (
              <div className="mt-8">
                <button
                  ...
                  className="w-full py-3 px-4 bg-slate-900 hover:bg-slate-800 disabled:bg-slate-300 text-white font-bold text-sm rounded-xl transition shadow-md flex items-center justify-center gap-2"
                >
                  <ShieldCheck size={18} />
